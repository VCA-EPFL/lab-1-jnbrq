 ...
 * 
 * On Wed Feb 28 16:45:09 CET 2024
 * 
 */
...
void MOD_mkVectorDot::init_symbols_0()
{
  ...
  init_symbol(&symbols[31u], "done_all__h3806", SYM_DEF, &DEF_done_all__h3806, 1u);
  ...
  init_symbol(&symbols[56u], "ready_start__h3377", SYM_DEF, &DEF_ready_start__h3377, 1u);
...
{
  tUInt8 DEF_x__h3530;
  tUInt8 DEF__0_CONCAT_pos_a_09_10_ULT_0_CONCAT_dim_11_12_MU_ETC___d118;
  tUInt8 DEF_NOT_0_CONCAT_pos_a_09_10_ULT_0_CONCAT_dim_11_1_ETC___d120;
  tUInt32 DEF_pos___h3464;
  tUInt8 DEF_x__h3564;
  DEF_x__h3564 = INST_pos_a.METH_read();
  DEF_x__h4092 = INST_dim.METH_read();
  DEF_x__h3718 = INST_i.METH_read();
  DEF_i___h3696 = (tUInt32)(DEF_x__h3718);
  DEF_pos___h3464 = (tUInt32)(DEF_x__h3564);
  DEF_dim___h3695 = (tUInt32)(DEF_x__h4092);
  DEF_y__h3711 = DEF_i___h3696 + 1u;
  DEF_y__h3707 = (tUInt32)(((tUInt64)(DEF_dim___h3695)) * ((tUInt64)(DEF_y__h3711)));
  DEF__0_CONCAT_pos_a_09_10_ULT_0_CONCAT_dim_11_12_MU_ETC___d118 = DEF_pos___h3464 < DEF_y__h3707;
  DEF_NOT_0_CONCAT_pos_a_09_10_ULT_0_CONCAT_dim_11_1_ETC___d120 = !DEF__0_CONCAT_pos_a_09_10_ULT_0_CONCAT_dim_11_12_MU_ETC___d118;
  DEF_x__h3530 = (tUInt8)255u & (DEF_x__h3564 + (tUInt8)1u);
  INST_a_memory.METH_put((tUInt8)0u, DEF_x__h3564, 2863311530u);
  INST_a_serverAdapter_writeWithResp.METH_wset((tUInt8)0u);
  if (DEF__0_CONCAT_pos_a_09_10_ULT_0_CONCAT_dim_11_12_MU_ETC___d118)
    INST_pos_a.METH_write(DEF_x__h3530);
  if (DEF_NOT_0_CONCAT_pos_a_09_10_ULT_0_CONCAT_dim_11_1_ETC___d120)
...
{
  tUInt8 DEF_x__h3739;
  tUInt8 DEF__0_CONCAT_pos_b_29_30_ULT_0_CONCAT_dim_11_12_MU_ETC___d131;
  tUInt8 DEF_NOT_0_CONCAT_pos_b_29_30_ULT_0_CONCAT_dim_11_1_ETC___d133;
  tUInt32 DEF_pos___h3697;
  tUInt8 DEF_x__h3758;
  DEF_x__h3758 = INST_pos_b.METH_read();
  DEF_x__h4092 = INST_dim.METH_read();
  DEF_x__h3718 = INST_i.METH_read();
  DEF_i___h3696 = (tUInt32)(DEF_x__h3718);
  DEF_pos___h3697 = (tUInt32)(DEF_x__h3758);
  DEF_dim___h3695 = (tUInt32)(DEF_x__h4092);
  DEF_y__h3711 = DEF_i___h3696 + 1u;
  DEF_y__h3707 = (tUInt32)(((tUInt64)(DEF_dim___h3695)) * ((tUInt64)(DEF_y__h3711)));
  DEF__0_CONCAT_pos_b_29_30_ULT_0_CONCAT_dim_11_12_MU_ETC___d131 = DEF_pos___h3697 < DEF_y__h3707;
  DEF_NOT_0_CONCAT_pos_b_29_30_ULT_0_CONCAT_dim_11_1_ETC___d133 = !DEF__0_CONCAT_pos_b_29_30_ULT_0_CONCAT_dim_11_12_MU_ETC___d131;
  DEF_x__h3739 = (tUInt8)255u & (DEF_x__h3758 + (tUInt8)1u);
  INST_b_memory.METH_put((tUInt8)0u, DEF_x__h3758, 2863311530u);
  INST_b_serverAdapter_writeWithResp.METH_wset((tUInt8)0u);
  if (DEF__0_CONCAT_pos_b_29_30_ULT_0_CONCAT_dim_11_12_MU_ETC___d131)
    INST_pos_b.METH_write(DEF_x__h3739);
  if (DEF_NOT_0_CONCAT_pos_b_29_30_ULT_0_CONCAT_dim_11_1_ETC___d133)
...
{
  tUInt8 DEF_x__h4057;
  tUInt32 DEF_x__h4021;
  tUInt8 DEF_pos_out_53_EQ_dim_11_MINUS_1_55___d156;
  tUInt32 DEF_v__h3813;
  tUInt32 DEF_v__h3913;
  tUInt32 DEF_y__h4041;
  tUInt8 DEF_x__h4076;
  ...
  DEF_x__h4040 = INST_output_res.METH_read();
  DEF_x__h4076 = INST_pos_out.METH_read();
  DEF_x__h4092 = INST_dim.METH_read();
  ...
  DEF_x__h1948 = DEF_x_wget__h1850;
  DEF_v__h3913 = DEF_b_serverAdapter_outData_ff_i_notEmpty____d54 ? DEF_x_first__h1735 : DEF_x__h1948;
  DEF_x__h472 = DEF_x_wget__h374;
  DEF_v__h3813 = DEF_a_serverAdapter_outData_ff_i_notEmpty____d4 ? DEF_x_first__h259 : DEF_x__h472;
  DEF_y__h4041 = (tUInt32)(((tUInt64)(DEF_v__h3813)) * ((tUInt64)(DEF_v__h3913)));
  DEF_pos_out_53_EQ_dim_11_MINUS_1_55___d156 = DEF_x__h4076 == ((tUInt8)255u & (DEF_x__h4092 - (tUInt8)1u));
  DEF_x__h4021 = DEF_x__h4040 + DEF_y__h4041;
  DEF_x__h4057 = (tUInt8)255u & (DEF_x__h4076 + (tUInt8)1u);
  ...
  INST_output_res.METH_write(DEF_x__h4021);
  INST_pos_out.METH_write(DEF_x__h4057);
  if (DEF_pos_out_53_EQ_dim_11_MINUS_1_55___d156)
...
void MOD_mkVectorDot::METH_start(tUInt8 ARG_start_dim_in, tUInt8 ARG_start_i)
{
  tUInt8 DEF_y__h4424;
  tUInt8 DEF_x__h4405;
  DEF_y__h4424 = (tUInt8)255u & ARG_start_i;
  DEF_x__h4405 = (tUInt8)((tUInt8)255u & (65535u & (((tUInt32)(ARG_start_dim_in)) * ((tUInt32)(DEF_y__h4424)))));
  INST_ready_start.METH_write((tUInt8)1u);
  INST_dim.METH_write(ARG_start_dim_in);
  INST_done_all.METH_write((tUInt8)0u);
  INST_pos_a.METH_write(DEF_x__h4405);
  INST_pos_b.METH_write(DEF_x__h4405);
...
tUInt8 MOD_mkVectorDot::METH_RDY_start()
{
  ...
  DEF_ready_start__h3377 = INST_ready_start.METH_read();
  DEF_CAN_FIRE_start = !DEF_ready_start__h3377;
...
tUInt8 MOD_mkVectorDot::METH_RDY_response()
{
  ...
  DEF_done_all__h3806 = INST_done_all.METH_read();
  DEF_CAN_FIRE_response = DEF_done_all__h3806;
...
unsigned int MOD_mkVectorDot::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "dim___h3695", 32u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "done_all__h3806", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "i___h3696", 32u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "ready_start__h3377", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h1948", 32u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h3718", 2u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h4040", 32u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h4092", 8u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  ...
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "y__h3707", 32u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "y__h3711", 32u);
...
void MOD_mkVectorDot::vcd_defs(tVCDDumpType dt, MOD_mkVectorDot &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
	...
	backing.DEF_b_serverAdapter_s1___d84 = DEF_b_serverAdapter_s1___d84;
      ...
      ++num;
      if ((backing.DEF_dim___h3695) != DEF_dim___h3695)
      {
	vcd_write_val(sim_hdl, num, DEF_dim___h3695, 32u);
	backing.DEF_dim___h3695 = DEF_dim___h3695;
      }
      ++num;
      if ((backing.DEF_done_all__h3806) != DEF_done_all__h3806)
      {
	vcd_write_val(sim_hdl, num, DEF_done_all__h3806, 1u);
	backing.DEF_done_all__h3806 = DEF_done_all__h3806;
      }
      ++num;
      if ((backing.DEF_i___h3696) != DEF_i___h3696)
      {
	vcd_write_val(sim_hdl, num, DEF_i___h3696, 32u);
	backing.DEF_i___h3696 = DEF_i___h3696;
      }
      ++num;
      if ((backing.DEF_ready_start__h3377) != DEF_ready_start__h3377)
      {
	vcd_write_val(sim_hdl, num, DEF_ready_start__h3377, 1u);
	backing.DEF_ready_start__h3377 = DEF_ready_start__h3377;
      }
      ++num;
	...
	backing.DEF_x__h1948 = DEF_x__h1948;
      ...
      ++num;
      if ((backing.DEF_x__h3718) != DEF_x__h3718)
      {
	vcd_write_val(sim_hdl, num, DEF_x__h3718, 2u);
	backing.DEF_x__h3718 = DEF_x__h3718;
      }
      ++num;
      if ((backing.DEF_x__h4040) != DEF_x__h4040)
      {
	vcd_write_val(sim_hdl, num, DEF_x__h4040, 32u);
	backing.DEF_x__h4040 = DEF_x__h4040;
      }
      ++num;
      if ((backing.DEF_x__h4092) != DEF_x__h4092)
      {
	vcd_write_val(sim_hdl, num, DEF_x__h4092, 8u);
	backing.DEF_x__h4092 = DEF_x__h4092;
      }
      ++num;
	...
	backing.DEF_x_wget__h374 = DEF_x_wget__h374;
      ...
      ++num;
      if ((backing.DEF_y__h3707) != DEF_y__h3707)
      {
	vcd_write_val(sim_hdl, num, DEF_y__h3707, 32u);
	backing.DEF_y__h3707 = DEF_y__h3707;
      }
      ++num;
      if ((backing.DEF_y__h3711) != DEF_y__h3711)
      {
	vcd_write_val(sim_hdl, num, DEF_y__h3711, 32u);
	backing.DEF_y__h3711 = DEF_y__h3711;
      }
      ++num;
    }
    else
